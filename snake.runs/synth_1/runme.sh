...
HD_PWD='D:/DOCUMENTI LUIGINO/GitHub/Snake/snake.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log logicagenerale.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source logicagenerale.tcl
