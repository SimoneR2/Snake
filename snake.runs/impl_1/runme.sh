...
HD_PWD='D:/DOCUMENTI LUIGINO/GitHub/Snake/snake.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log logicagenerale.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source logicagenerale.tcl -notrace
