...
set_property -dict { PACKAGE_PIN K15   IOSTANDARD LVCMOS33 } [get_ports { su }]; #IO_L24P_T3_RS1_15 Sch=led[1]
set_property -dict { PACKAGE_PIN J13   IOSTANDARD LVCMOS33 } [get_ports { destra }]; #IO_L17N_T2_A25_15 Sch=led[2]
set_property -dict { PACKAGE_PIN N14   IOSTANDARD LVCMOS33 } [get_ports { giu }]; #IO_L8P_T1_D11_14 Sch=led[3]
set_property -dict { PACKAGE_PIN R18   IOSTANDARD LVCMOS33 } [get_ports { sinistra }]; #IO_L7P_T1_D09_14 Sch=led[4]
...
#set_property -dict { PACKAGE_PIN V11   IOSTANDARD LVCMOS33 } [get_ports { clock1hz}]; #IO_L21N_T3_DQS_A06_D22_14 Sch=led[15]
...
#set_property -dict { PACKAGE_PIN P18   IOSTANDARD LVCMOS33 } [get_ports { ckd1 }]; #IO_L9N_T1_DQS_D13_14 Sch=btnd
...
set_property -dict { PACKAGE_PIN B11   IOSTANDARD LVCMOS33 } [get_ports { sincH }]; #IO_L4P_T0_15 Sch=vga_hs
set_property -dict { PACKAGE_PIN B12   IOSTANDARD LVCMOS33 } [get_ports { sincV }]; #IO_L3N_T0_DQS_AD1N_15 Sch=vga_vs
